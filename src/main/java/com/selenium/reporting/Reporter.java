...
public class Reporter implements ITestListener {
	...
	public static void takeScreenShot( String screenshotName) {
		...
		FileUtils.copyFile(fullScreenshot, new File(testMethodReportFolder  + "//" + screenshotName + "_"+ timeStamp + ".png"));
		}catch(Exception e) {
...
public static void extentScreenShot( ) {
	...
	public static void info(String message) {
        ...
        extentScreenShot();
        ExtentManager.getTest().info(message, MediaEntityBuilder.createScreenCaptureFromBase64String(screenshotBase64).build());
      }
   ...
   public static void fail(String message) {
      ...
      extentScreenShot();
      ExtentManager.getTest().fail(message, MediaEntityBuilder.createScreenCaptureFromBase64String(screenshotBase64).build());
      screenshotBase64 = null;
      }
